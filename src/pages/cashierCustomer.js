...
const CashierCustomer = () => {
  ...
  return (
    <div className="dash-wrapper">
      <header>
        <div className="top">
          <Link href="/"><img src="../../public/assets/images/banka-blue-logo.svg" alt="logo" /></Link>
      ...
      <div className="banner">
        <div className="customer">
          ...
          <img className="customer-avatar" src="../../public/assets/images/emeka copy@3x.png" alt="customer avatar" />
          <h4 id="owner">Timi Tejumola</h4>
        </div>
        <div className="balance">
          <p>CURRENT BALANCE</p>
          <h3 id="current-balance">N100,0000</h3>
        </div>
      </div>
      <div className="content">
        <button className="credit-button" id="credit-button" type="button">
